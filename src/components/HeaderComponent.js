...
function HeaderComponent(){
    ...
    return(
        <div className="flex justify-between bg-pink-50 shadow-lg sm:bg-blue-50 md:bg-yellow-300">
            <TitleComponent/>
            ...
            {
               isLoogedIn?<button onClick={()=>setisLoogedIn(false)}>Logout</button>:<button onClick={()=>setisLoogedIn(true)}>Login</button>
            }
        </div>
    )
}
